...
def test_table():
    ...
    simulation(os.path.join(filedir,'table.cfg'))
    surface1 = Surface(filename = os.path.join(filedir,'table.srf'))
    surface2 = Surface(filename = os.path.join(filedir,'table.srf_save'))

...
def test_yamamura():
    ...
    simulation(os.path.join(filedir,'yamamura.cfg'))
    surface1 = Surface(filename = os.path.join(filedir,'yamamura.srf'))
    surface2 = Surface(filename = os.path.join(filedir,'yamamura.srf_save'))
